...
export class TipoEventoService {
  ...
  editarTipoEvento(tipoEventoDto :TipoEventoDto ,id:number):Observable<TipoEventoResponse>{
    return this.http.put<TipoEventoResponse>(`${this.URL_BASE}/tipoEvento/${id}`,tipoEventoDto)
  }
